...
if __name__ == "__main__":
    ...
    parser.add_argument('-strbool', '--strboolswitcher', type=str_bool_switcher_type, default=False)
    parser.add_argument('-tuples', '--tuple_options', type=tuple_type, default=('hey', 33))
    
    args = parser.parse_args() 
    
    print(args.strboolswitcher)
    print(args.tuple_options)
